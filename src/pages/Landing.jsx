  ...
  return (
    <>
      ...
      <section className="py-8 pb-24">
        ...
        <button className="block mx-auto bg-primary text-white text-[14px] font-medium uppercase tracking-widest py-2.5 px-4 mt-8">
        ...
        <section>
          ...
          <div className="max-w-6xl mx-auto grid gap-4 py-8 lg:grid-cols-4">
            ...
            {[
              ...
              <div
                key={i}
                className="border-[2px] border-black p-4 flex flex-col justify-between"
              >
                <div>
                ...
                <div className="mt-12 text-center">
                  ...
                  <button className="block mx-auto bg-primary text-white text-lg font-semibold tracking-widest py-1.5 px-6 mt-8">
                    Select Plan
                  </button>
                <div className="h-[80px] pt-5 font-semibold">{p.term || ""}</div>
                </div>
              </div>
            ))}
          </div>
